...
class PollsController extends Controller
{
    ...
    public function __construct(){
        ...
        if (Auth::check())
        {
            $this->perms = get_role_permissions($this->auth,'polls');
            $this->perms = array_add($this->perms,count($this->perms),'active');
            $this->perms = array_add($this->perms,count($this->perms),'vote');
            $this->perms = ['except' => $this->perms];

        }else{
            $this->perms = guest_role_permissions('polls');
            $this->perms = array_add($this->perms,count($this->perms),'vote');
            $this->perms = ['except' => $this->perms];
        }
        /**
        ...
        $this->middleware('RedirectUser',['except'=>['show','vote']]);
