...
! function(e, a, t) {
    ...
    function i() {
        ...
        bootbox.dialog(a, [{
            ...
            "class": "btn-inverse",
            callback: function() {
                var a = e("#create_text_file_name").val(),
                    t = e("#textfile_create_area").val();
                if (null !== a) {
                    a = y(a);
                    var n = e("#sub_folder").val() + e("#fldr_value").val() + a,
                        i = e("#cur_dir_thumb").val() + a;
                    e.ajax({
                        type: "POST",
    ...
    function r(a) {
        ...
        var t = a.find(".rename-file").attr("data-thumb"),
            n = a.find(".rename-file").attr("data-path");
        e.ajax({
            type: "POST",
    ...
    function v(t) {
        var n = e(".breadcrumb").width() + t,
            i = e("#view"),
            r = e("#help");
        if (e(".uploader").css("width", n), i.val() > 0) {
            if (1 == i.val()) e("ul.grid li, ul.grid figure").css("width", "100%");
            else {
    ...
    function h() {
        var a = e(this);
        0 == e("#view").val() && (1 == a.attr("toggle") ? (a.attr("toggle", 0), a.animate({
            top: "0px"
        }, {
            queue: !1,
            duration: 300
        })) : (a.attr("toggle", 1), a.animate({
            top: "-30px"
        }, {
            queue: !1,
            duration: 300
    ...
    function x(a, t) {
        var n = e("li.dir", "ul.grid").filter(":visible"),
            i = e("li.file", "ul.grid").filter(":visible"),
            r = [],
            o = [],
            l = [],
            c = [];
        n.each(function() {
            ...
            if (e.isNumeric(n))
                for (n = parseFloat(n);
                     "undefined" != typeof r[n] && r[n];) n = parseFloat(parseFloat(n) + parseFloat(.001));
            else n = n + "a" + a.find("h4 a").attr("data-file");
            r[n] = a.html(), o.push(n)
        }), i.each(function() {
            var a = e(this),
                n = a.find(t).val();
            if (e.isNumeric(n))
                for (n = parseFloat(n);
                     "undefined" != typeof l[n] && l[n];) n = parseFloat(parseFloat(n) + parseFloat(.001));
            else n = n + "a" + a.find("h4 a").attr("data-file");
            l[n] = a.html(), c.push(n)
    ...
    var j = "9.9.3",
        ...
        S = function(a) {
            var t = e("#base_url").val() + e("#cur_dir").val(),
                n = a.find("a.link").attr("data-file");
        ...
        U = {
            contextActions: {
                ...
                edit_img: function(a) {
                    var t = a.attr("data-name"),
                        n = e("#base_url_true").val() + e("#cur_dir").val() + t,
                        i = e("#aviary_img");
                ...
                select: function(a) {
                    ...
                    if (t = 1 == e("#popup").val() ? window.opener : window.parent, "" != i)
                        if (1 == e("#crossdomain").val()) t.postMessage({
            ...
            makeSort: function(a) {
                ...
                e(".sorter").on("click", function() {
                    var n = e(this);
                    t = e("#sort_by").val() === n.attr("data-sort") ? 0 == t ? !0 : !1 : !0, a ? (e.ajax({
    ...
    e(document).ready(function() {
        if (e("#rfmDropzone").on("click", ".dz-success .dz-detail", function() {
            ...
            }), U.bindGridEvents(), parseInt(e("#file_number").val()) > parseInt(e("#file_number_limit_js").val())) var t = !1;
        else var t = !0;
        if (U.makeSort(t), U.makeFilters(t), e("#info").on("click", function() {
                ...
                bootbox.prompt(e("#insert_folder_name").val(), e("#cancel").val(), e("#ok").val(), function(a) {
                    if (null !== a) {
                        a = y(a).replace(".", "");
                        var t = e("#sub_folder").val() + e("#fldr_value").val() + a,
                            n = e("#cur_dir_thumb").val() + a;
                        e.ajax({
                            type: "POST",
                ...
                var a = e(this);
                e(".view-controller button").removeClass("btn-inverse"), e(".view-controller i").removeClass("icon-white"), a.addClass("btn-inverse"), a.find("i").addClass("icon-white"), e.ajax({
                ...
                placement: "right"
            }), e("body").addClass("no-touch")), e(".paste-here-btn").on("click", function() {
            ...
            r.on("mouseover", function() {
                0 == e("#view").val() && e("#main-item-container").hasClass("no-effect-slide") === !1 && e(this).find(".box:not(.no-effect)").animate({
                    top: "-26px"
                }, {
                    queue: !1,
                    duration: 300
                ...
                0 == e("#view").val() && e(this).find(".box:not(.no-effect)").animate({
                    top: "0px"
                }, {
                    queue: !1,
                    duration: 300
        ...
        var i = e("#cur_dir").val(),
            r = e("#subdir").val(),
            o = e("#base_url").val(),
            l = a.substr(0, a.lastIndexOf(".")),
            c = a.split(".").pop();
        c = c.toLowerCase();
        var d = "",
            s = ["ogg", "mp3", "wav"],
            p = ["mp4", "ogg", "webm"],
            f = e("#return_relative_url").val(),
            u = encodeURL((1 == f ? r : o + i) + a);
        if ("" != t)
            if (1 == e("#crossdomain").val()) n.postMessage({
                sender: "responsivefilemanager",
                url: u,
                field_id: t
            }, "*");
        ...
        if (1 == e("#popup").val()) var n = window.opener;
        ...
        var r = e("#subdir").val();
        r = r.replace("\\", "/");
        var o = e("#base_url").val(),
            l = e("#return_relative_url").val(),
            c = encodeURL((1 == l ? r : o + i) + a);
        if ("" != t)
            if (1 == e("#crossdomain").val()) n.postMessage({
                sender: "responsivefilemanager",
                url: c,
        ...
        if ("" != t)
            if (1 == e("#crossdomain").val()) n.postMessage({
                ...
                var d = e("#" + t, n.document);
                var st = e("." + t, n.document);
                var did = e("." + t, n.document).data('id');
                //var lab = c.split('/');
                //var num = lab.length - 1;

                st.html('<b class="btn btn-warning">'+did+'</b><img src="'+c+'"/>').trigger("change");
                d.val(c).trigger("change"), "function" == typeof n.responsive_filemanager_callback && n.responsive_filemanager_callback(t), _()
            } else apply_any(c)
        ...
        var i = n.find(".download-form"),
            r = "form" + (new Date).getTime();
        ...
        var c = a.find("a.rename-file"),
            d = a.find("a.delete-file"),
            s = c.attr("data-path"),
            p = c.attr("data-thumb"),
            f = s.replace(r, t + "." + o),
            u = p.replace(r, t + "." + o);
        ...
        a.find("h4 > a").text(t);
        var i = a.find(".folder-link"),
            r = i.attr("href"),
            o = e("#fldr_value").val(),
            l = r.replace("fldr=" + o + encodeURIComponent(n), "fldr=" + o + encodeURIComponent(t));
        i.each(function() {
            e(this).attr("href", l)
        });
        var c = a.find("a.delete-folder"),
            d = a.find("a.rename-folder"),
            s = d.attr("data-path"),
            p = d.attr("data-thumb"),
            f = s.lastIndexOf("/"),
            u = s.substr(0, f + 1) + t;
