<li>
    ...
    <div class="desc">
        ...
        <span>
            <a href="{{action('WelcomeController@showArticle',checkItem($item->translate_slug,$item->slug))}}">{{recordDesc($item->head,$item->body,136,recordTitle($item->frontpage_title,$item->title),60)}}</a>
        </span>
        <br>
