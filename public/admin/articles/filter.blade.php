    ...
    {!! Form::open(['action'=>['Admin\ArticlesController@filter',(Input::get('partner')) ? 'partner=1' : ''],'method'=>'POST','class'=>'form-horizontal']) !!}
        <div class="control-group" style="position:relative;">
            ...
            <div class="row">
                ...
                <div class="col-sm-2">{!! Form::select('a_type',[''=>'all','article'=>'Article','video'=>'Video','photogallery'=>'PhotoGallery','audio'=>'Audio','study-online'=>'Study online'],filter_request($request,'a_type'),['class'=>'controls form-control','style'=>'width:100%']) !!}</div>
